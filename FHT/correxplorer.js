...
window.onload=function(){
  ...
  var load_all = function(){
      ...
      fileType = d3.select("select#fileType")[0][0].value;
      arrayType = d3.select("select#arrayType")[0][0].value;
      arraySize = d3.select("select#byteLength")[0][0].value;
      fileName = arrayType+"_"+fileType+"_"+arraySize+".csv";
      
    d3.csv(arrayType+"/"+fileName, function(data){
...
//      d3.select("input#keep_symmetry")[0][0].checked;
...
//  });
  ...
  var sort_process = "value";
      //d3.select("select#sort_func")[0][0].value;
